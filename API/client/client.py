...
class CryptomusClient:
  ...
  async def create_wallet(
    ...
    return await self.session(CreateWallet(**self.__get_func_params(locals()))) # can return text/html. status 405
  
  async def block_wallet(self, uuid: str, order_id: str, is_force_refund: bool = False) -> BlockWalletResponse:
  ...
  async def blocked_address_refund(
      seld, address: str, *, uuid: str | None=None, order_id: str | None=None
